package org.zhang.common.mybatis.handler;
...
import org.zhang.common.core.domain.dto.RoleDTO;
import org.zhang.common.core.domain.model.LoginUser;
import org.zhang.common.core.exception.ServiceException;
import org.zhang.common.core.utils.SpringUtils;
import org.zhang.common.core.utils.StreamUtils;
import org.zhang.common.core.utils.StringUtils;
import org.zhang.common.mybatis.annotation.DataColumn;
import org.zhang.common.mybatis.annotation.DataPermission;
import org.zhang.common.mybatis.enums.DataScopeType;
import org.zhang.common.mybatis.helper.DataPermissionHelper;
import org.zhang.common.satoken.utils.LoginHelper;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Zhang/issues/IB4CS4
